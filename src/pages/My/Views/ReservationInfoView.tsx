        ...
        {data.map((item:any)=>{
            return(
                ...
                <li key={item.reservationId} style={{display:'flex',justifyContent:'center',padding:'0 18rem',cursor:'pointer'}} onClick={()=>handleClickOpen(item)}>
                  ...
                  <li key={item.reservationId} style={{display:'flex',justifyContent:'center',padding:'0 18rem',cursor:'pointer'}} onClick={()=>alert("예매취소된 공연입니다!")}>
                  ...
                  <img src={cancelimg} alt="cancel" style={{position:'absolute', zIndex:'1'}} />
                    <div style={{position:'absolute',height:'13rem',width:'100%',justifyContent:'center',alignItems:'center',display:'flex',backgroundColor:'#333',opacity:'0.5',borderRadius:'1rem'}}/>
